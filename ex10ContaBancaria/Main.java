...
public class Main {
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("1 - Criacao de ex01ContaBancaria.Conta\n" + "2 - Deposito\n" + "3 - Saque\n" + "4 - Calculo Rendimento \n"
                    + "5 - Consultar Saldo\n" + "6 - Pagar Fatura\n" + "7 - Sair\n");
            ...
            if (opcao == 1) { //CRIAR CONTA
                ...
                System.out.println("1- ex01ContaBancaria.Conta Corrente\n" + "2- ex01ContaBancaria.Conta Poupança\n" + "3- ex01ContaBancaria.Conta Salario\n");
                ...
                {
                    System.out.println("O campo id está nulo!");
                }finally {
                    ler.nextLine();
                }
                ...
                try {
                    ...
                    System.out.println("O campo tipo conta está nulo!");
                }finally {
                    ler.nextLine();
                }
